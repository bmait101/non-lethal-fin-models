...
theme_Publication <- function (base_size=12, base_family="Helvetica") 
{
  ...
  theme_grey(base_size = base_size, base_family = base_family) %+replace% 
    ...
    theme(  
      ...
      axis.title.y  = element_text(colour = "black", size = rel(1), angle = 90, margin = margin(t = 0, r = 5, b = 0, l = 0)),
      axis.text.y   = element_text(colour = "black", size = rel(1), hjust = 1, margin = margin(t = 0, r = 3, b = 0, l = 0)),
